...
| **`careguard-core`** | Family Caregiving & Medical Records | Multi-doctor coordinator, 4-slot pillbox scheduler, vitals anomaly detection & 1-page clinical visit briefing sheet. | [`careguard-core`](https://github.com/Muybi3n/AI_Projects/tree/careguard-core) |

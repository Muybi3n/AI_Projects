...
| **`drivemesh-core`** | Cloud Storage & Deduplication | Google Drive / Cloud metadata subject clustering, fuzzy revision deduplication, bloat auditing & restructuring planner. | [`drivemesh-core`](https://github.com/Muybi3n/AI_Projects/tree/drivemesh-core) |
